...
#ifndef NEWCASTLEAPP_H_
#define NEWCASTLEAPP_H_
...
namespace newcastlev2v {

// NewCastle class inherits from DemoBaseApplLayer
class NewCastleApp : public veins::DemoBaseApplLayer {
protected:
