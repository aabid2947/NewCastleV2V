...
#include "../NewCastleApp/NewCastleApp.h"
...
using namespace newcastlev2v;

// Register your custom application module
Define_Module(newcastlev2v::NewCastleApp);
...
void NewCastleApp::initialize(int stage) {
...
void NewCastleApp::handleMessage(omnetpp::cMessage* msg) {
...
void NewCastleApp::handleSelfMsg(omnetpp::cMessage* msg) {
...
void NewCastleApp::sendBroadcast() {
    veins::TraCIMobility* mobilityModule = dynamic_cast<veins::TraCIMobility*>(getParentModule()->getSubmodule("veinsmobility"));
    if (!mobilityModule) {
...
void NewCastleApp::onWSM(veins::BaseFrame1609_4* wsm) {
...
void NewCastleApp::handleGradientFromServer(veins::BaseFrame1609_4* msg) {
    if (!msg) {
...
void NewCastleApp::handlePositionUpdate(cObject* obj) {
